...
Der sichtbare Test war erfolgreich. Alle 21 Manifest-Assets wurden geladen;
...
Der Prototyp bleibt bewusst ein Machbarkeitsnachweis: Er verwendet keine echten
PET-Produktionsassets, migriert die Python-Runtime nicht, besitzt kein
Kontextmenue und noch kein Walk-/Chase-Verhalten. Die bisherigen Pose-Sprites
bleiben Referenzen, sind aber nicht der kuenftige Hauptanimationspfad.
